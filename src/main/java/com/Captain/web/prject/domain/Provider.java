 ...
 * author:dcs
 * time:2021/10/23 15:10
 * description:
 *id	bigint	主键ID
 * proCode	varchar	供应商编码
 * proName	varchar	供应商名称
 * proDesc	varchar	供应商详细描述
 * proContact	varchar	供应商联系人
 * proPhone	varchar	联系电话
 * proAddress	varchar	地址
 * proFax	varchar	传真
